 ...
 * @author WEB-01
 */
public class FRM_Cadastro_Fornecedores extends javax.swing.JFrame {
    ...
    public FRM_Cadastro_Fornecedores() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tabelacliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "nome", "cnjp", "email", "telefone", "celular", "cep", "endereco", "numero", "complemento", "bairro", "cidade", "estado"
            }
        ));
    ...
    private void tabelaclienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaclienteMouseClicked
        ...
        txtcnpj.setText(tabelacliente.getValueAt(tabelacliente.getSelectedRow(), 2).toString());
        ...
        txtendereço.setText(tabelacliente.getValueAt(tabelacliente.getSelectedRow(), 7).toString());
        ...
        boxtxtestado.setSelectedItem(tabelacliente.getValueAt(tabelacliente.getSelectedRow(), 12).toString());
    ...
    private void btpesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btpesquisaActionPerformed
        ...
        Fornecedoredao dao = new Fornecedoredao();
        List<Fornecedores> lista = dao.BuscaFornecedores(nome);
        DefaultTableModel dados = (DefaultTableModel) tabelacliente.getModel();
        dados.setNumRows(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRM_Cadastro_Fornecedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FRM_Cadastro_Fornecedores().setVisible(true);
            }
        });
    }
